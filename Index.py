...
PassLabel = Label(RightFrame, text='Password:', fon=('Century Gothic', 20), bg='MIDNIGHTBLUE', fg='white')
...
def Register():
    ...
    def RegisterToDataBase():
        ...
        if (Name == '' and Email == '' and User == '' and Pass == ''):
            messagebox.showerror(title='Register Error', message='Please complete all fields')
        else:
            DataBaser.cursor.execute('''
